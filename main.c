/**
        ...
        0.117: исправлена работа кнопок для масштабирования, если мышка не наведена на кнопки
        0.118: окно отвечает независимо от delay анимации
        0.119: исправлена ошибка работы с однокадровой анимацией
        0.120: исправлено отображение GIF-анимаций с неявным значением Frame Blending Mode
        0.121: исправлена возможность менять файлы путём перетаскивания файла в окно
        0.122: исправлено отображение GIF-анимаций с неявным значением Frame Blending Mode
        0.123: исправлено сохранение настроек при замене анимации путём перетаскивания файла в окно
