...
/**
        ...
        1.0.2:
            ...
            - Кнопка с названием утилиты во всплывающем меню открывает этот сайт
            - Изменено всплывающее меню с настройками
            - Изменен интерфейс регулировки воспроизведения
            - Исправлена коллизия всплывающих меню, вызванных кнопкой
