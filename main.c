...
/**
        ...
        1.1.2:
            ...
            - Игнорирование ввода сохраняется в файле settings
            - Оптимизировано всплывающее меню с настройками
            - Предпросмотр корректно отображает размер меньше чем 10 пикселей
